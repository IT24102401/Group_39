...
<head>
    ...
    <title>HR Staff Dashboard - HR Help Desk</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="dashboard-container">
    ...
    <div class="main-content">
        ...
        <div id="profile" class="card">
            ...
            <form action="HRStaffUpdateProfile" method="post">
                <div class="form-row">
                    <div class="form-group">
            ...
            <% } else { %>
            <div class="error-message" style="display: block;">
                HR Staff information is not available. Please log in again or contact support.
            </div>
            <% } %>
        </div>
        ...
        <div id="in-progress-tickets" class="card" style="display: none;">
            ...
            <table class="ticket-table">
                ...
                <% } %>
                <% } else { %>
                <tr><td colspan="5">No high-priority in-progress tickets.</td></tr>
                <% } %>
                </tbody>
            </table>
            ...
            <table class="ticket-table">
                ...
                <% } %>
                <% } else { %>
                <tr><td colspan="5">No medium/low-priority in-progress tickets.</td></tr>
                <% } %>
                </tbody>
            </table>
        </div>
        ...
        <div id="resolved-tickets" class="card" style="display: none;">
            ...
            <table class="ticket-table">
                ...
                <% } %>
                <% } else { %>
                <tr><td colspan="5">No resolved tickets.</td></tr>
                <% } %>
                </tbody>
            </table>
        </div>
