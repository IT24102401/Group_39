...
import com.hrhelpdesk.db.DBConnection; // Ensure this import is present
import com.hrhelpdesk.model.User;
import java.sql.Connection;
import java.sql.PreparedStatement;
import java.sql.SQLException;

public class EmployeeUserDAO extends BaseUserDAO {
    ...
    public void saveUser(User user, String plainPassword) throws SQLException {
        updateUserProfile(user); // For employee, save = profile update
    }
}