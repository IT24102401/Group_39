...
public class AdminDashboardServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if ("search".equals(action)) {
                ...
                // Add user - Use a factory-like approach or let service handle instantiation
                int roleId = Integer.parseInt(request.getParameter("role_id"));
                User newUser = createUserInstance(roleId); // New method to instantiate correct subclass
    ...
    // Helper method to instantiate the correct User subclass based on roleId
