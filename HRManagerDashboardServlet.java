...
public class HRManagerDashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Fetch open, in-progress, resolved, and wait-listed tickets
            ...
            List<Ticket> waitListedTickets = ticketDAO.getAllWaitListedTickets(); // New method to fetch wait-listed tickets
            ...
            request.setAttribute("waitListedTickets", waitListedTickets); // Set wait-listed tickets as attribute
            ...
            for (Ticket ticket : waitListedTickets) { // Fetch attachments for wait-listed tickets
                List<String> attachmentNames = ticketDAO.getAttachmentNames(ticket.getTicketId());
                request.setAttribute("attachmentNames_" + ticket.getTicketId(), attachmentNames);
            }
